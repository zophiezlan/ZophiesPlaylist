...
def tester14():
    params = {"type": "artist-radio", "artist": "weezer", "results": 100}
...
def tester15():
    ...
    params = {"type": "artist-radio", "artist": "weezer", "results": 50}
...
def tester22():
    ...
    coffee = PlaylistSource("coffeehouse", ucoffee_house)
    he = AttributeRangeFilter(coffee, "echonest.energy", min_val=0.5)
    runner(Debugger(he))
...
def tester25():
    ...
    shortmetal = AttributeRangeFilter(
        metal, "spotify.duration_ms", max_val=1000 * 60 * 3
    )
    runner(shortmetal)
...
def tester26():
    ...
    high_energy_coffee = AttributeRangeFilter(encoffee, "echonest.energy", min_val=0.5)
...
def tester29():
    ...
    metal = EchoNestGenreRadio("metal", 40)
    ninties_metal = AttributeRangeFilter(
        metal, "echonest.album_date", min_val="1990", max_val="2000"
    )
...
def tester43():
    ...
    ps = CustomSorter(
        PlaylistSource("Teen Party"), lambda tid: len(tlib.get_attr(tid, "title"))
    )
    runner(ps)
